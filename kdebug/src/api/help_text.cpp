...
const char* fallback_help_text() {
    return
        ...
        "  kdebug trace-driver --daidir <simv.daidir|kdb.elab++>|--session <id> --signal <sig>\n"
        "      Query static RTL driver evidence from a daidir or native elab++ database.\n\n"
        "  kdebug active-driver --daidir <simv.daidir|kdb.elab++> --fsdb <waves.fsdb> --signal <sig> --time <time>\n"
