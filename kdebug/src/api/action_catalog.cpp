...
std::string schema_root() {
    const char* home = std::getenv("KVERIF_HOME");
    if (home && *home) return std::string(home) + "/kdebug/schemas/v1/actions/";
    return "kdebug/schemas/v1/actions/";
}
