...
void print_shortcut_help() {
    std::cout
        ...
        << "  kdebug session-open --name <id> [--daidir simv.daidir|kdb.elab++] [--fsdb waves.fsdb]\n"
        ...
        << "  kdebug trace-driver --daidir <simv.daidir|kdb.elab++>|--session <id> --signal <sig> [--include-source]\n"
        << "  kdebug active-driver --session <id>|--daidir <simv.daidir|kdb.elab++> --fsdb <waves.fsdb> --signal <sig> --time <time>\n"
